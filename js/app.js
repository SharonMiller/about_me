...
//   }
//   if (numGuess === 2 ) {
//     alert('You are all out of guesses.');//user is all out of guesses
//   }
// }
...
// var statesLivedIn = ['washington', 'oregon', 'nebraska', 'california'];
...
var statesGuessed = 0;
var states;
states = prompt('Please guess a state I have lived in');
